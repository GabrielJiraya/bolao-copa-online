...
function pointsFor(game, guess) {
  ...
  if (resultType(guess.homeScore, guess.awayScore) === resultType(game.homeScore, game.awayScore)) return 3;
  if ((guess.homeScore - guess.awayScore) === (game.homeScore - game.awayScore)) return 1;
  return 0;
}
